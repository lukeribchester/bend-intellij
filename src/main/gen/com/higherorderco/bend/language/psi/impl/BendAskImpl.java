...
public class BendAskImpl extends ASTWrapperPsiElement implements BendAsk {

  public BendAskImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public BendPattern getPattern() {
    return findChildByClass(BendPattern.class);
  }
