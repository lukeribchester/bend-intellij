...
public class BendBindImpl extends ASTWrapperPsiElement implements BendBind {

  public BendBindImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public BendAsk getAsk() {
    return findNotNullChildByClass(BendAsk.class);
  }
