...
public class BendMatchArmImpl extends ASTWrapperPsiElement implements BendMatchArm {

  public BendMatchArmImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public BendPattern getPattern() {
    return findNotNullChildByClass(BendPattern.class);
  }
