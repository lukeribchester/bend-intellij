...
public class BendNumOpImpl extends ASTWrapperPsiElement implements BendNumOp {

  public BendNumOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BendVisitor visitor) {
    visitor.visitNumOp(this);
  }
  ...
  @Override
  @NotNull
  public BendOperator getOperator() {
    return findNotNullChildByClass(BendOperator.class);
  }
