...
public class BendSwitchArmImpl extends ASTWrapperPsiElement implements BendSwitchArm {

  public BendSwitchArmImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BendVisitor visitor) {
    visitor.visitSwitchArm(this);
  }
